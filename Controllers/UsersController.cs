...
namespace Temperature_Recording.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UsersID,FullName,Email,UserTypeID")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UsersID,FullName,Email,UserTypeID")] User user)
        {
            if (ModelState.IsValid)
            {
